/*
  Inspired by
  - https://github.com/kubernetes/kubernetes/blob/master/pkg/kubelet/dockershim/libdocker/instrumented_client.go
*/
package libdocker
...
import (
	...
	"github.com/tangfeixiong/go-to-docker/pkg/kubeletcopycat/dockershim/metrics"
)
