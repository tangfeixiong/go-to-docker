...
func (c *exporterServiceClient) Measure(ctx context.Context, in *MeteringReqResp, opts ...grpc.CallOption) (*MeteringReqResp, error) {
...
func _ExporterService_Measure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExporterServiceServer).Measure(ctx, req.(*MeteringReqResp))
	}
...
var fileDescriptorExporter = []byte{
	...
	0xcf, 0x4d, 0x2d, 0x29, 0xca, 0x4c, 0x86, 0x08, 0x18, 0xc5, 0x73, 0xf1, 0xbb, 0x42, 0x0d, 0x09,
	0x4e, 0x2d, 0x2a, 0xcb, 0x4c, 0x4e, 0x15, 0xf2, 0xe1, 0x62, 0xf7, 0x4d, 0x4d, 0x2c, 0x2e, 0x2d,
	0x4a, 0x15, 0x12, 0xd6, 0x2b, 0x48, 0xd2, 0xf3, 0x4d, 0x2d, 0x49, 0x2d, 0xca, 0xcc, 0x4b, 0x0f,
	0x4a, 0x2d, 0x0c, 0x4a, 0x2d, 0x2e, 0x90, 0xc2, 0x26, 0xa8, 0x24, 0xde, 0x74, 0xf9, 0xc9, 0x64,
	0x26, 0x41, 0x25, 0x1e, 0xfd, 0x32, 0x43, 0x90, 0x0d, 0x60, 0x49, 0x2b, 0x46, 0x2d, 0x27, 0x81,
	0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc6, 0x63, 0x39,
	0x86, 0x24, 0x36, 0xb0, 0xcd, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xf4, 0x48, 0x67, 0x59,
	0xc1, 0x00, 0x00, 0x00,
}
