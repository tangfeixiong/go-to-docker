...
public class QrcodeClient {
	 ...
	 * @return {boolean}
	 */
	public BufferedImage encode(String contents, BarcodeFormat barcodeFormat, Integer margin,
			ErrorCorrectionLevel errorLevel, String format, int width, int height, String saveImgFilePath) throws ZxingClientQrcodeException {
		Boolean bool = false;
		...
		try {
			...
			//e.printStackTrace();
            throw new ZxingClientQrcodeException("Transform QRCODE to image object failed", e);
		}
		return bufImg;
	}
